...
| **[Loja Integrada](https://www.lojaintegrada.com.br/)** | Brazilian e-commerce SaaS platform with built-in store setup, payments, shipping, marketplace integrations, and an API. | Paid plans start at R$ 46/month; annual billing is discounted. | **Permanent free plan**: up to 50 products and 5,000 visits per month. | Private company / Revenue not publicly disclosed |
| **[Tray](https://tray.com.br/)** | Brazilian e-commerce SaaS platform focused on multichannel selling, with marketplace, social commerce, payment, shipping, and POS integrations. | Plans start at R$ 19/month on annual billing; monthly plans start at R$ 59/month. | No permanent free tier. | Private company (part of LWSA) / Revenue not separately disclosed |
| **[Yampi](https://yampi.com.br/)** | Brazilian e-commerce SaaS platform with a storefront, transparent checkout, marketing features, and integrations for payments, logistics, and ERP. | Paid plans start at R$ 47/month, plus a per-order fee. | **Permanent free plan** (Basic): no monthly fee, with a 2.5% fee per paid order. | Private company / Revenue not publicly disclosed |
...
| **[VTEX](https://www.vtex.com/)** | Brazilian enterprise commerce platform for B2C, B2B, marketplace, and order-management operations, serving brands in 43 countries. | Custom pricing; contact sales for a quote. | No permanent free tier. | Public company (NYSE: VTEX) |
