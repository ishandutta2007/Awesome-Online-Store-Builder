...
| **[Squarespace](https://www.squarespace.com/)** | Website builder with sleek, designer-grade templates and robust store features. | Personal plan starts at $16/mo (billed annually), and Commerce plans start at $28/mo. | No permanent free tier. Offers a 14-day free trial. | Valuation: ~$6.9B / Revenue: ~$1B+/yr |
| **[Nuvemshop (Tiendanube)](https://www.nuvemshop.com.br/)** | Leading LATAM e-commerce SaaS platform with 180k+ merchants across 5 countries. Full ecosystem: store builder, payments (Nuvem Pago), shipping, POS, and AI tools. | Plans from R$ 69/mo (Essencial). Free Começo plan available (no transaction fees via Nuvem Pago). Annual billing: 15% off. | **Permanent free plan** (Começo): unlimited products, visits, and sales with Nuvem Pago. 7-day free trial on paid plans. | Valuation: ~$3.1B (unicorn, Series E 2021) / Revenue: ~$126M ARR |
...
| **[VTEX](https://www.vtex.com/)** | Brazilian enterprise commerce platform for B2C, B2B, marketplace, and order-management operations, serving brands in 43 countries. | Custom pricing; contact sales for a quote. | No permanent free tier. | Valuation: ~$710M / Revenue: ~$247M/yr |
| **[BigCommerce](https://www.bigcommerce.com/)** | Enterprise-grade SaaS ecommerce platform with extensive out-of-the-box features. | Standard plan starts at $39/mo (or $29/mo if billed annually). | No permanent free tier. Offers a 15-day free trial. | Valuation: ~$500M / Revenue: ~$300M+/yr |
| **[Tray](https://tray.com.br/)** | Brazilian e-commerce SaaS platform focused on multichannel selling, with marketplace, social commerce, payment, shipping, and POS integrations. | Plans start at R$ 19/month on annual billing; monthly plans start at R$ 59/month. | No permanent free tier. | Valuation: ~$432M (Locaweb) / Revenue: Unknown |
| **[Loja Integrada](https://www.lojaintegrada.com.br/)** | Brazilian e-commerce SaaS platform with built-in store setup, payments, shipping, marketplace integrations, and an API. | Paid plans start at R$ 46/month; annual billing is discounted. | **Permanent free plan**: up to 50 products and 5,000 visits per month. | Valuation: Subsidiary of VTEX / Revenue: ~$15.3M/yr |
| **[Jumpseller](https://jumpseller.com/)** | Chilean all-in-one e-commerce platform with store building, local payment and shipping integrations, multichannel sales, and POS capabilities. | Plans start at US$ 10.80/month on annual billing. | No permanent free tier; offers a 7-day free trial without a credit card. | Valuation: ~$11.9M / Revenue: ~$4M/yr |
...
| **[Yampi](https://yampi.com.br/)** | Brazilian e-commerce SaaS platform with a storefront, transparent checkout, marketing features, and integrations for payments, logistics, and ERP. | Paid plans start at R$ 47/month, plus a per-order fee. | **Permanent free plan** (Basic): no monthly fee, with a 2.5% fee per paid order. | Valuation: Private / Revenue: Unknown |

### Advanced & Specialized Platforms

**Other notable mentions**: Various niche ecommerce builders.
...
- **[Nimbus Design System](https://github.com/TiendaNube/nimbus-design-system)** [![GitHub stars](https://img.shields.io/github/stars/TiendaNube/nimbus-design-system?style=social&color=white)](https://github.com/TiendaNube/nimbus-design-system/stargazers) — Open-source design system (components, tokens, icons) from Nuvemshop/Tiendanube (MIT). Used in production by 180k+ LATAM stores.
- **[Tiendanube SDKs](https://github.com/TiendaNube)** [![GitHub stars](https://img.shields.io/github/stars/TiendaNube/nube-sdk?style=social&color=white)](https://github.com/TiendaNube/nube-sdk/stargazers) — Official SDKs (Node.js, PHP), CLI, and app templates for building integrations and themes on the Nuvemshop platform (MIT).
